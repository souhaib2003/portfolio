...
import Contactan from './../../../public/animation/Contactan.json';
const Contact = () => {


   const [state, handleSubmit] = useForm("xjkwqlqk");
      ...
      />
        ...
        {state.succeeded && (<p className="flex" style={{ fontSize: "18px" , marginTop : "1.7rem"}}>
          ...
          Your message has been sent successfully 👌 </p>)}
             ...
             <div className=" "> <Lottie className="contact-animation" style={{height:355 }} animationData={Contactan} /></div>
       </div>
    </section>
  );
};
